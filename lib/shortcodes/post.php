 ...
 */
add_shortcode('post_date', 'hasloo_post_date_shortcode');
function hasloo_post_date_shortcode($atts) {
	...
	return apply_filters('hasloo_post_date_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_time', 'hasloo_post_time_shortcode');
function hasloo_post_time_shortcode($atts) {
	...
	return apply_filters('hasloo_post_time_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_author', 'hasloo_post_author_shortcode');
function hasloo_post_author_shortcode($atts) {
	...
	return apply_filters('hasloo_post_author_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_author_link', 'hasloo_post_author_link_shortcode');
function hasloo_post_author_link_shortcode($atts) {
	...
	return apply_filters('hasloo_post_author_link_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_author_posts_link', 'hasloo_post_author_posts_link_shortcode');
function hasloo_post_author_posts_link_shortcode($atts) {
 ...
 */
add_shortcode('post_comments', 'hasloo_post_comments_shortcode');
function hasloo_post_comments_shortcode($atts) {
	
	$defaults = array(
		'zero' => __('Leave a Comment', 'hasloo'),
		'one' => __('1 Comment', 'hasloo'),
		'more' => __('% Comments', 'hasloo'),
		'hide_if_off' => 'enabled',
		'before' => '',
		'after' => ''
	);
	...
	if ( ( !hasloo_get_option('comments_posts') || !comments_open() ) && $atts['hide_if_off'] === 'enabled' )
		return;
	...
	return apply_filters('hasloo_post_comments_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_tags', 'hasloo_post_tags_shortcode');
function hasloo_post_tags_shortcode($atts) {
	
	$defaults = array(
		'sep' => ', ',
		'before' => __('Tagged With: ', 'hasloo'),
		'after' => ''
	);
	$atts = shortcode_atts( $defaults, $atts );
	...
	return apply_filters('hasloo_post_tags_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_categories', 'hasloo_post_categories_shortcode');
function hasloo_post_categories_shortcode($atts) {
	
	$defaults = array(
		'sep' => ', ',
		'before' => __('Filed Under: ', 'hasloo'),
		'after' => ''
	);
	$atts = shortcode_atts( $defaults, $atts );
	...
	return apply_filters('hasloo_post_categories_shortcode', $output, $atts);
 ...
 */
add_shortcode('post_edit', 'hasloo_post_edit_shortcode');
function hasloo_post_edit_shortcode($atts) {
	...
	return apply_filters('hasloo_post_edit_shortcode', $output, $atts);
