 ...
 * @return string
 */
function hasloo_truncate_phrase($phrase, $max_characters) {
...
function get_the_content_limit($max_char, $more_link_text = '(more...)', $stripteaser = 0) {
	...
	$content = hasloo_truncate_phrase($content, $max_char);
 ...
 * 
 */
function hasloo_rel_nofollow($xhtml) {
	$xhtml = hasloo_strip_attr($xhtml, array('a'), array('rel'));
 ...
 * 
 * @example hasloo_strip_attr('<a class="class" href="http://google.com/">Google</a>', array('a'), array('class'));
 *
 ...
 * @since 1.0
 */
function hasloo_strip_attr($xhtml, $elements, $attributes, $two_passes = true) {
 ...
 * @since 1.1
 */
function hasloo_tweet_linkify($tweet) {
