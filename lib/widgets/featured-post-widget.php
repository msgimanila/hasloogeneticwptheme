...
add_action('widgets_init', create_function('', "register_widget('Hasloo_Featured_Post');"));
class Hasloo_Featured_Post extends WP_Widget {

	function Hasloo_Featured_Post() {
		...
		$this->WP_Widget( 'featured-post', __('Hasloo - Featured Posts', 'genesis'), $widget_ops, $control_ops );
	}
