...
add_action('widgets_init', create_function('', "register_widget('Hasloo_Latest_Tweets_Widget');"));
class Hasloo_Latest_Tweets_Widget extends WP_Widget {

	function Hasloo_Latest_Tweets_Widget() {
		...
		$this->WP_Widget( 'latest-tweets', __('Hasloo - Latest Tweets', 'genesis'), $widget_ops, $control_ops );
	}
