...
<div id="content-sidebar-wrap">
	...
	<?php hasloo_before_loop(); ?>
		...
		<div class="post hentry">
			...
			<h1 class="entry-title"><?php _e('Not Found, Error 404', 'hasloo'); ?></h1>
			<div class="entry-content">
				<p><?php printf(__('The page you are looking for no longer exists. Perhaps you can return back to the site\'s <a href="%s">homepage</a> and see if you can find what you are looking for. Or, you can try finding it with the information below.', 'hasloo'), get_bloginfo('url')); ?></p>
			</div>
